...
int main() {
    ...
    //as linhas abaixo inserem os números 1, 2 e 3 na fila f, respectivamente
    f.inserir(1);
    f.inserir(2);
    f.inserir(3);

    f.remover(); //remove o elemento no início da fila f

    f.imprimir(); //imprime todos os elementos na fila f
